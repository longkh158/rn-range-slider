...
const Slider = ({
  ...
  // const gestureHander = Animated.event(
  //   /**
  //    * @param {import('react-native-gesture-handler').GestureHandlerGestureEvent} event
  //    */
  //   event => {},D
  //   {useNativeDriver: true},
  // );
  const gestureHandler = Animated.event([{nativeEvent: {x: pointerX}}], {
    useNativeDriver: true,
    /**
     * @param {import('react-native-gesture-handler').PanGestureHandlerGestureEvent} event
     */
    listener: event => {
      ...
      switch (nativeEvent.state) {
        case State.BEGAN: {
          ...
          const {numberOfPointers: numberActiveTouches} = nativeEvent;
          ...
          // eslint-disable-next-line no-shadow
          const {current: highThumbX} = highThumbXRef;
          const {x: downX, absoluteX: pageX} = nativeEvent;
    ...
    <PanGestureHandler onGestureEvent={gestureHandler}>
      <View {...restProps}>
        ...
        <View onLayout={handleContainerLayout} style={styles.controlsContainer}>
          ...
          <View style={styles.touchableArea} collapsable={false} />
        </View>
      </View>
    </PanGestureHandler>
  );
